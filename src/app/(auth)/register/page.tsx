  ...
  return (
    <main className='relative min-h-screen w-full bg-background-page md:bg-auth-gradient lg:px-[100px]'>
      <div className='mx-auto w-full max-w-[375px] md:max-w-[768px] lg:max-w-[1440px]'>
        ...
        <div className='flex flex-col items-center lg:mt-16 lg:flex-row lg:justify-between lg:gap-20'>
          <div className='order-2 mt-2 flex w-full justify-center md:mt-[140px] md:px-[70px] lg:order-1 lg:mt-0 lg:px-0 lg:max-w-[628px]'>
            <RegisterForm />
          </div>
          <div className='order-1 flex flex-col items-center md:order-3 lg:order-2'>
            ...
            <div className='hidden md:flex mt-[98px] items-center gap-2 text-center font-primary text-base leading-6 text-text-secondary md:pb-[106px] lg:mt-4 lg:pb-0'>
              <span>Word</span>
              <span>·</span>
